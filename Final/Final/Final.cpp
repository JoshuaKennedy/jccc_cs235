CIS 235 - Test # 2     Spring, 2013                          NAME: Brandon Anderson
...
public:
	...
	virtual void f3(void)const { cout <<"Brandon\n";}
...
{ 	one a;
	...
	print(a); Output: Bill 
	print(b); Output: Brandon
	print(c); Output: Brandon
}